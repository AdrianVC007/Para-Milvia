...
const planetData = [
  {
    ...
    texture: assetUrl("textures/mercury.jpg"), emissive: "#251a0e",
  ...
  },
  {
    ...
    texture: assetUrl("textures/venus.jpg"), emissive: "#3a2000",
  ...
  },
  {
    ...
    texture: assetUrl("textures/earth.jpg"), emissive: "#001025",
  ...
  },
  {
    ...
    texture: assetUrl("textures/mars.jpg"), emissive: "#2e0a00",
  ...
  },
  {
    ...
    texture: assetUrl("textures/jupiter.jpg"), emissive: "#201000",
  ...
  },
  {
    ...
    texture: assetUrl("textures/saturn.jpg"), emissive: "#1e1400",
    rings: true,
  ...
  },
  {
    ...
    texture: assetUrl("textures/uranus.jpg"), emissive: "#002828",
  ...
  },
  {
    ...
    texture: assetUrl("textures/neptune.jpg"), emissive: "#00003a",
...
══════════════════════════════════════════ */
const photoContent = [
  { src: assetUrl("photos/1-image-1772974188959.png"),           title: "Tu fuerza",       text: "Me encanta cómo peleas por lo que quieres y nunca te rindes. Esa determinación me enamora." },
  { src: assetUrl("photos/2-image-1772974244006.png"),           title: "Cómo me cuidas",  text: "Tu manera de cuidarme es uno de los regalos más bonitos que tengo en mi vida." },
  { src: assetUrl("photos/3-image-1772974292039.png"),           title: "Tu ternura",      text: "Tu dulzura hace que todo en mi día se sienta más bonito y liviano." },
  { src: assetUrl("photos/4-image-1772974346919.png"),           title: "Tu mirada",       text: "Tus ojos tienen un brillo que me deja sin palabras cada vez que te miro." },
  { src: assetUrl("photos/5-image-1772974360453.png"),           title: "Tu alegría",      text: "Tu risa es mi sonido favorito en este universo entero." },
  { src: assetUrl("photos/6-image-1772974434583.png"),           title: "Tu estilo",       text: "Eres hermosa de una forma tan única y auténtica que no puedo evitar admirarte." },
  { src: assetUrl("photos/7-image-resized-1772974461695.webp"),  title: "Tu corazón",      text: "Siempre piensas en los demás. Eso te hace una persona gigante y especial." },
  { src: assetUrl("photos/8-image-1772974478202.png"),           title: "Malcriadooo",     text: "Cuando me dices malcriadooo me derrites por completo. No lo cambio por nada. 😄" },
  { src: assetUrl("photos/9-image-resized-1772974529470.webp"),  title: "Tu magia",        text: "Tienes una vibra que convierte cualquier momento ordinario en algo especial." },
  { src: assetUrl("photos/10-image-1772974698683.png"),          title: "Tú, completa",    text: "Eres mi niña hermosa, mi orgullo, mi tranquilidad y mi universo entero." }
];
...
function createSolarSystem() {
  ...
  let sunTex;
  loader.load(assetUrl("textures/sun.jpg"),
  ...
  planetData.forEach((pd, idx) => {
    ...
    if (pd.rings) {
      ...
      loader.load(assetUrl("textures/saturn_ring.png"),
